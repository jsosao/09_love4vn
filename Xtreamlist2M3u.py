...
class GetChannels:
    def __init__(self, url: str = None, host: str = None, port: int = None, 
        ...
        self.sport_keywords = ["SPORT", "SPORTS", "Thể thao", "LIVE", "Live", "Spor", "Sport", "Matches", "MATCHES", "Direct", "DIRECT", "Event", "EVENT", "Events", "EVENTS", "Hub Premier", "DAZN (UK)", "EPL", "Football", "La Liga", "UEFA", "Premier League", "Golf", "Tennis", "4K UHD 3840P"]
        self.banned_keywords = ["Live Cam", "LIVECAM", "Webcam", "CAMERA", "Cam", "CAM", "camera", "cam", "BETTING",  "Betting"]
        self.unwanted_sports = ["CRICKET", "RUGBY", "NHL", "BASEBALL", "UFC", "MMA", "Cric", "CKT", "RUGY", "BASEBALL", "HOCKEY", "NFL", "NRL", "AHL", "ARL", "Events/PPV", "Matchroom", "STAN EVENT", "Speedway", "Clubber", "FITETV", "SKWEEK", "GAAGO", "EFL", "MLS Pass", "National League", "PDC", "ARL", "SPFL", "Wrestling", "WSL", "WWE", "MOLA", "NCAAB", "NCAAF", "OHL", "JHL", "STAN", "Supercross", "WHL", "WNBA", "IN/PK", "REPLAY", "Flo", "Dirtvision", "Ligue 1 Pass", "Malaysia", "Saudi Arabia", "STARZPLAY", "Ultimate Pool", "FANDUEL", "NIFL", "XFL", "Box Office", "Backup"]
...
def generate_sorted_playlist(channels: List[Tuple]) -> List[str]:
    ...
    live_keywords = ["LIVE", "FOOTBALL", "TRỰC TIẾP", "EVENT", "MATCH", "GAME", "DIRECT", "UK", "NL"]
